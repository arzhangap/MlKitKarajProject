package com.arzhang.project.karajuniversityproject.presentation.screens.face_mesh
...
import com.arzhang.project.karajuniversityproject.analyzer.FaceMeshDetectionAnalyzer
import com.arzhang.project.karajuniversityproject.presentation.common.components.CameraView
import com.arzhang.project.karajuniversityproject.presentation.common.utils.adjustFaceMeshPoints
...
import com.arzhang.project.karajuniversityproject.presentation.common.utils.drawLandmark
import com.arzhang.project.karajuniversityproject.presentation.common.utils.drawTriangle
    ...
    Canvas(modifier = Modifier.fillMaxSize()) {
        faces.forEach { face ->
            ...
            face.allPoints.forEach {
                val landmark = adjustFaceMeshPoints(PointF(it.position.x,it.position.y),imageWidth, imageHeight, screenWidth,screenHeight)
                drawLandmark(landmark, Color.Cyan, 3f)
            }

            face.allTriangles.forEach { triangle ->
                val points = triangle.allPoints.map {
                    adjustFaceMeshPoints(PointF(it.position.x, it.position.y), imageWidth, imageHeight, screenWidth, screenHeight)
                }
